...
spoiler_level: heavy
gm_secret: true
thumbnail: zz_media/covers/o_fraturamento.png
cover: zz_media/covers/o_fraturamento.png
...
> ![[zz_media/covers/o_fraturamento.png|400]]
...
1. Fragmento de Cristal Primitivo
2. Lâmina do Primeiro Cavaleiro
3. O Livro Sem Fim
...
> [!warning]
> A lista acima é rascunho preservado. Nenhum desses fragmentos deve ser criado como item canônico sem decisão do Sage.
...
- Decidir se o Fraturamento é fato, mito, teoria falsa ou metáfora religiosa.
- Definir se existem mesmo seis fragmentos.
- Definir relação com Earthropo, Criadores e Véu Cinzento.
- Definir se algum fragmento será usado como item, dungeon, arco ou apenas mito.
