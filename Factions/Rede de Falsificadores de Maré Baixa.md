...
Organização por trás dos remédios falsos investigados por [[Varkh Nimalis]]. Esta rede está usando o símbolo e os métodos de [[Mestre Odran Veyl]] para produzir e distribuir remédios falsificados em Nimalia. A identidade completa da organização, seus membros e motivações permanecem desconhecidas.

## Função Narrativa

A rede de falsificadores representa o antagonismo central do arco de Varkh. Ela força Varkh a investigar, proteger o nome de seu mestre e confrontar questões de identidade, reputação e responsabilidade. A organização pode estar conectada a facções maiores de Nimalia ou operar de forma independente no submundo.
...
- É uma organização que produz remédios falsificados
- Usa o símbolo antigo de Odran em seus produtos
- Distribui remédios falsos em Nimalia
- Produz documentos falsificados com assinaturas perfeitas demais
...
- Identidade completa da organização
- Líderes e membros da rede
- Motivação por trás do uso do símbolo de Odran
- Escala da operação de falsificação
- Conexão com facções maiores de Nimalia
- Localização de produção e distribuição
- Se Odran está envolvido com a rede
- Origem do conhecimento alquímico usado
- Destino final da organização no arco de Varkh
- Relação definitiva com Varkh e grandes facções
