...
Esta nota reúne a consulta mecânica usada em mesa: dados de vida, permissões de equipamento, progressão e números principais.
...
|---|---|
| Dados de Vida | D8 |
| Armaduras | Pode usar todo tipo de armadura e escudos |
| Armas | Maça, cajado, mangual, martelo ou funda; armas cortantes bloqueiam afastar mortos-vivos e novas magias divinas enquanto portadas |
| Itens mágicos | Pode usar itens mágicos compatíveis com o alinhamento de seu deus |
| Magias | Usa magias divinas; não precisa de grimório |
| Afastar mortos-vivos | Usos por dia iguais ao nível de Clérigo; quantidade afetada depende de Carisma |
| Templo e seguidores | A partir do 11º nível, pode construir templo e conquistar seguidores |

## Progressão

| Nível | XP | DV/PV | BA | JP | 1º | 2º | 3º | 4º | 5º | 6º | 7º |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 0 | 1 | +1 | 15 | 1 | — | — | — | — | — | — |
| 2 | 1.500 | 2 | +1 | 15 | 2 | — | — | — | — | — | — |
| 3 | 3.000 | 3 | +2 | 15 | 2 | 1 | — | — | — | — | — |
...
Legenda: `A` afasta automaticamente; `D` destrói; `N` sem efeito.

| Nível | 1 DV | 2 DV | 3 DV | 4 DV | 5 DV | 6 DV | 7 DV | 8 DV | 9 DV | 10 DV | 11 DV | 12 DV | 13 DV | 14 DV | 15 DV | 16 DV | 17 DV | 18 DV |
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
...
| Caminho | Nível | Benefício de consulta |
|---|---:|---|
| Druida | 5 | Desloca-se sem deixar rastros e comunica-se com animais silvestres usando reação de Carisma |
| Druida | 8 | Pode controlar animais silvestres e assumir forma de criatura média ou menor de até 8 DV, 3 vezes ao dia |
| Druida | 16 | Pode transformar-se em criatura de até 16 DV, com habilidades, 3 vezes ao dia |
| Cultista | 5 | Pode controlar morto-vivo por até 24 horas em vez de afastar automaticamente |
| Cultista | 8 | Pode afastar criaturas ordeiras como afasta mortos-vivos |
| Cultista | 16 | Pode transformar um braço em três tentáculos de 4m, 3 vezes ao dia, por 1 hora |
| Caçador | 5 | Modificador de Carisma afasta o dobro de dados de mortos-vivos |
| Caçador | 8 | Pode repetir falha de JP contra dreno de nível/atributo de morto-vivo e sente mortos-vivos em raio de 30m |
| Caçador | 16 | Atinge mortos-vivos incorpóreos sem penalidade e fica imune a efeitos mentais originados de morto-vivo |
