...
| metrica | valor |
|---|---:|
| linhas de plano analisadas | 46 |
| arquivos alterados/aplicaveis | 44 |
| tags oficiais adicionadas/aplicaveis | 44 |
| arquivos pulados | 2 |
...
| arquivo | motivo |
|---|---|
| `Factions/Culto dos Sussurrantes.md` | nenhuma adicao segura autorizada |
| `Workflow/_audit/Class_Rules_Standardization/RULES_FOLDER_CONSOLIDATION_REPORT.md` | arquivo em area de auditoria, archive ou legacy |

## Motivos gerais de pulo

- Factions/Culto dos Sussurrantes.md: `antagonista` so e seguro em contexto de personagem
