...
| `Races/Vampiro.md` | `race` | `race` |  |  | `subtype`, `work_status`, `canon_status`, `requires_review` | medium | review_before_apply | vampiro é raça/condição, não classe. |
...
| `CAMPANHA/Rumors/02 - Remédios Falsos da Maré Baixa.md` | `lore` | `lore` |  |  | `subtype`, `work_status`, `canon_status`, `requires_review` | medium | review_before_apply | inferido pela pasta Lore. subtype de lore precisa revisão. subtype ausente sem inferência de baixo risco. |
