...
- A Home agora usa `zz_media/thumbnails/avenor.png`; o banner de Disgraceland deixou de aparecer na página ativa.
...
| [[MAPA DE NIMALIS]] | `nimalia-capital-map` | `zz_media/maps/mapa_de_nimalis.png` | 1 |
