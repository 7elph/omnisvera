...
| `Ficha do Jão.pdf` | Ficha recebida sem nome, também sobre modelo da edição anterior | Registro provisório; associação com [[Varkh Nimalis]] ainda pendente. |
...
Isso não remove os poderes de [[Vezemir]]. A origem, o acesso no nível 1 e a versão mecânica usada na campanha precisam ser definidos como regra da mesa ou vinculados a um item, bênção ou outra fonte narrativa.
